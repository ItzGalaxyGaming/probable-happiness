// Esto está hecho para que no aparezca que no estamos utilizando los eventos en la consola de Unity.
// La idea es que no lo usen, solo es para ejemplos de las clases.
...
namespace Clases.PA2024.Utilities.Lambda
{
    ...
    public class Lambda : MonoBehaviour
    {
        ...
        {
            Debug.Log($"El enemigo llamado: {name}, cambio su estado a {(dead ? "vivo" : "muerto")} y el nombre de mi objeto es: {thisObject.name} ");
        }
    }
